...
contract IMMORTALITY is BEP20, Pausable, BEP20Detailed {
    
	address teamWallet = 0x4DaF1ca09BFC702581CF3DA9329827490d7bEB55;
    address serviceWallet = 0xF073e760040EB46CC8327B13d40E2f0b278cf287;
    address partnerWallet = 0x38ac6722EeaBF9660aA4aE329b673a24Ed7C5696;
    address presaleWallet = 0x2AEA939d1Fcc0279DB76e320C40f491d9BB1d2F9;
	...
	constructor() public BEP20Detailed("IMMORTALITY", "IMMO", 9) {  
	        
       
        totalCoins = 500000000 * 10 ** uint256(decimals());
        _mint(owner(), totalCoins); // total supply fixed at 500 Million coins
        
        BEP20.transfer(teamWallet, 50000000 * 10 ** uint256(decimals()));  
        BEP20.transfer(partnerWallet, 50000000 * 10 ** uint256(decimals()));
        BEP20.transfer(serviceWallet, 150000000 * 10 ** uint256(decimals()));
        BEP20.transfer(presaleWallet, 150000000 * 10 ** uint256(decimals()));
